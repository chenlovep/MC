...
//class VTKFILTERSCORE_EXPORT vtkMarchingCubesSpace : public vtkPolyDataAlgorithm 
...
struct Cube{
	...
	int index;
	bool Flag;
	Cube(int i=0,int j=0,int k=0,int id=0,bool f=0):
		oi(i),oj(j),ok(k),index(id),Flag(f){}
};
